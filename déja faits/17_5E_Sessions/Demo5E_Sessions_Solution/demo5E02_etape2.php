<?php
	...
	// on vérifie que les champs nom et prenom sont bien renseignés
	...
	// si on arrive d'une autre étape et que les données sont initialisées
		...
		// on garde l'étape 2
		$_SESSION['etapeCV']=2;
	// si les données n'ont jamais été initialisées
	} else {
	...
	// on recupère l'id de la session courante
...
<body>
    ...
    <!--Redige vers l'éape 3 après submission du formulaire   -->
