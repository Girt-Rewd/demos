<?php
	...
	// Si le formulaire provient de l'étape 2, on initialise la variable de session 'profession'
	...
	// Si le formulaire provient de l'étape 3, on ajoute une autre exepérience de travail
