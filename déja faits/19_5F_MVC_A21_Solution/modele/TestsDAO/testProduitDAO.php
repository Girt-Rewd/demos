...
<body>
    ...
    <?php 
           ...
           $unProduit=ProduitDAO::chercher(101);
			echo "<ul><li> Produit 101 => ".($unProduit?$unProduit:"n'existe pas")."</li></ul>";
    ...
    <?php 
			...
			$unProduit = new Produit(555, 'Banc de scie économique','marque','aucune', 456.78, 2);
    ...
    <?php 
			...
			// Vérification
			$unProduit=ProduitDAO::chercher(555); // remplacer le null, par l'appel de la bonne méthode pour récuperer le produit 555 
    ...
    <?php 
			...
			// enlever le commentaire pour supprimer le produit
