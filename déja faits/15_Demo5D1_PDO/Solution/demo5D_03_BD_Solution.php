...
<body>
    <!-- ============================= Access BD =========================== -->
    <h1>Mise à jour de la BD (PDO:exec, PDO::rollback, PDO::commit)</h1>
    <?php
    ...
    <?php	    
			...
			//On utilise transaction dans le cas ou on souhaite traiter  
			//un groupe de commandes comme un seul bloc
			//beginTransaction() permet de placer sur la connexion avant  
			//le debut du groupe de requêtes 
			//qui doit être traité comme un bloc.
			...
			// ========= Affichage Après la Modification, avant le Rollback ====================================
			...
			// ========= Affichage Après l'Annulation/confirmation de la Transaction =========================================
