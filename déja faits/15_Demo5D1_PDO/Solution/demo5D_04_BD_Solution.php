...
<body>
    <!-- ============================= Access BD =========================== -->
    <h1>Requêtes programmables (PDOStatement::prepare et PDOStatement::execute)</h1>
    <?php
		...
		?>
    <?php	  
			// ========================= REQUÊTE PROGRAMMABLE AVEC SELECT =====================================
		    // Préparation de la requête programmable #1, avec select pour un code
			echo "<h2> Select programmable avec code </h2>";
			// ********************************* À compléter *****************
			//•	préparer une requête SQL dans une chaine de caractères 
			//en remplaçant les informations programmables par 
			//des points d’interrogation.
			//et récupérer l’instance de type PDOStatement qui est retourné.
			...
			// ********************************* À compléter *****************
			//Appeler la méthode execute de l’instance de PDOStatement 
			//en lui passant les paramètres requis sous forme de tableau. 
			...
			// ======================== REQUÊTE PROGRAMMABLE AVEC UPDATE =====================================
			...
			// ********************************* À compléter *****************
			 $requeteProgrammable2=$connexion->prepare("UPDATE produit SET
			 quantite=quantite+? WHERE code=?");

		    // .... Execution de la requête programmble #2 avec le code 101 et quanitite a ajaouter de 3
			$quantiteAAjouter = 3;
			$codeRecherche = 101;
			// ********************************* À compléter *****************
			$requeteProgrammable2-> execute(array($quantiteAAjouter,$codeRecherche));
