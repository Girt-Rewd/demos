...
<body>
    ...
    <?php	  
			...
			// ********************************* À compléter *****************
			$requeteProgrammable2=$connexion->prepare("UPDATE produit SET quantite=quantite+? WHERE code=?");
			...
			$rangee=$requeteProgrammable1->fetch();
			echo "[#".$rangee['code'].", Desc.:".$rangee['description'].", Qté:".$rangee['quantite'].", Prix:".$rangee['prix']."$]<br /><br />";
           echo "<h2> Revenir en arriere Update programmable avec code et quantite</h2>";
